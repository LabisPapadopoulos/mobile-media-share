...
public interface MediaServiceAsync {
	public void getMedia(final User currentUser, final String title, final MediaType type, final String user,
	...
	public void getMedia(final User currentUser, final String title, final MediaType type, final String user, final Date createdFrom, 
